---
name: GitHub Profile README Content
description: Complete markdown content for Juan Antonio Pérez's GitHub profile (UPDATED 2026-05-04 with TokyoNight theme)
type: reference
originSessionId: 60f0cf5f-a245-4c1d-8082-78be6707edd9
lastUpdated: 2026-05-04
---
Este es el contenido completo del README.md actualmente en producción en el repositorio especial `Baxone`:

**Cambios más recientes (commit 68d1c7d):**
- Tema de estadísticas GitHub cambiado de **nord** a **tokyonight**
- Agregación de badges estáticos de especialidades y experiencia
- Parámetro `hide_border=false` en estadísticas para mejor visualización
